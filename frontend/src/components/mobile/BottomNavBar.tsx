...
// Tab ids and icons only — labels are rendered via useTranslation so they
// respond to language changes at runtime without a page reload.
    ...
    >
      <div className="flex items-stretch h-16">
        {TABS.map((tab) => {
          ...
          // Translation key pattern: tabs.home, tabs.search, tabs.portfolio, tabs.profile
